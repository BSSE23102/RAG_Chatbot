...
Across the session, industry experts tackle the hard questions: why loan stacking has become endemic in SME lending, how misaligned broker incentives are shaping product selection, and what role technology, including AI, can play in routing businesses toward the right funding at the right time. NETSOL's [asset finance software](https://netsoltech.com/solutions/asset-finance) is built for exactly this kind of complexity, supporting lenders who want to move beyond transactional models toward relationship-led, data-informed lending.
## What needs to change in SME finance
The panel identified five structural issues holding back the SME finance market:
  * **Loan stacking is a systemic problem:** Some SMEs carry more than ten concurrent facilities, with businesses paying £80,000–£90,000 per month purely in servicing costs, yet none of those facilities addresses the underlying cash-flow structure.
...
The shift requires building platforms that prioritise long-term suitability alongside speed, systems that can hold a view of an SME's full funding position, not just the current transaction. For lenders ready to make that shift, the [Haydock Finance case study](https://netsoltech.com/insights/case-studies/empowering-haydock-with-streamlined-lending) with NETSOL's platform offers a practical reference point for what technology-led transformation looks like in a UK asset finance context.
## Going deeper: Related reading
The debate in this session connects directly to a broader strategic question explored at the [AFC Autumn Conference](https://netsoltech.com/blog/netsol-is-a-silver-sponsor-at-the-afc-autumn-conference-2025), where Jason Hurwitz argued the case for direct, technology-driven lending models as the most scalable path forward. For the full webinar's key findings, check the [Finance Connect's webinar review](https://finance-connect.com/sme-finance-changes-needed-for-better-outcomes-for-smes-brokers-and-lenders/) of the panel discussion and its implications for the SME lending market.
## Related webinars
